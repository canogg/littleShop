                ...
                Image("monstro02")
                  ...
                  Image("line")
                    ...
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        Text("Monstrinho fofo de borracha em ótimo estado, ideal para crianças de 03 a 05 anos de idade")
                            .font(.system(size: 15, weight: .light,design: .rounded))
...
struct Brinquedo03View_Previews: PreviewProvider {
